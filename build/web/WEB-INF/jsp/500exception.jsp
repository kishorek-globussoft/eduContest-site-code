...
<html lang="en">
   <head>
        ...
        <title>Contest.EduMongoose | 404</title>
        ...
        <link href="../view/assets/plugins/animate.css" type="text/css" rel="stylesheet" media="screen,projection">
    ...
    <body class=" error_bg">
        ...
        <main>
            <div class="container">
                <div class="col m12 center error_404_text margin_top_20">      
                    <h1 class="animated infinite tada">500</h1>
