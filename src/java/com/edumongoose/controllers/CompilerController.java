...
public class CompilerController {
    ...
    final String JAVAPATH = System.getProperty("user.home") + "//java//";//"d://programs//java//";
    final String CPATH = System.getProperty("user.home") + "//c//";//"d://programs//c//";
    final String CPLUSPATH = System.getProperty("user.home") + "//cpp//";//"d://programs//cpp//";
    ...
    public String javaCompiler(Program program, BindingResult result, Model model, HttpServletRequest request) throws InterruptedException, IOException {
