...
<link href="../../views/css_auditmysite/codemirror.css" rel="stylesheet" type="text/css"/>
...
<section id="widget-grid" class="">
    ...
    <!-- END ROW -->
    <script src="../../views/js_auditmysite/codemirror.js" type="text/javascript"></script>
    <script src="../../views/js_auditmysite/xml.js" type="text/javascript"></script>
                                ...
                                $.ajax({
                                    ...
                                    success: function (data) {
                                        ...
                                        for (var i = 0; i < tripleGroups.length; i++) {
                                            ...
                                            var StrUndefiend = result.tripleGroups[i].nodes[0].id;

                                            if (StrUndefiend === undefined) {
                                            ...
                                            toAppend += '<h2>' + result.tripleGroups[i].type + '</h2>';

                                            if (result.tripleGroups[i].numErrors > 0) {

                                                var errors = result.tripleGroups[i].numErrors;

                                                toAppend += '<h2 style="margin-left: 330px;">' + errors + ' Errors</h2>';
                                            ...
                                            toAppend += '</tr>';
                                            toAppend += '</thead>';
                                            toAppend += '<tbody class="datatabs" id="id-dataproduct' + i + '">';
...
//                                            $('#id-dataproducturl' + i).append(result.tripleGroups[i].nodes[0].id);
                                            ...
                                            $('#id-dataproduct' + i).append("<tr><td>" + result.tripleGroups[i].nodes[0].type.value + ": <br>" + "</td><td>" + StrUndefiend + "<br>" + "</td></tr>");
                                            ...
                                            for (var j = 0; j < result.tripleGroups[i].nodes.length; j++) {
                                                ...
                                                for (var k = 0; k < nodesproperties.length; k++) {
                                                    ...
                                                    $('#id-dataproduct' + i).append();

//                                                        $('#id-dataimages' + i).append(nodespred + "<br>");

//                                                       $('#id-dataimagesvalue' + i).append(nodesvalue + "<br>");

                                                    $('#id-dataproduct' + i).append("<tr><td>" + nodespred + ": <br>" + "</td><td>" + nodesvalue + "<br>" + "</td></tr>");
...
//                                                  $(".datatabs").append(offersTab);
                                                ...
                                                for (var m = 0; m < offers.length; m++) {
                                                    ...
                                                    var OfferUndefiend = offerurl;

                                                    if (OfferUndefiend === undefined) {
...
//                                                    $('#id-dataofferurl' + i).append(offerurl);
                                                    ...
                                                    $('#id-dataproduct' + i).append("<tr><td>" + offer + ": <br>" + "</td><td>" + OfferUndefiend + "<br>" + "</td></tr>");
...
//                                                        $('#id-datacurrencyvalue' + i).append(valuedata + "<br>");
                                                        ...
                                                        $('#id-dataproduct' + i).append("<tr><td>" + preddata + ": <br>" + "</td><td>" + valuedata + "<br>" + "</td></tr>");
                                                    }
                                                }
                                            }
                                        }
